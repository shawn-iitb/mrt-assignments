...
class Metaclass_AddThreeInts_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('qr_stuff')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from qr_stuff.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from qr_stuff.srv._add_three_ints import AddThreeInts_Request as Request
    from qr_stuff.srv._add_three_ints import AddThreeInts_Response as Response
