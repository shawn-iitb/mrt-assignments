...
#include "qr_stuff/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const qr_stuff::msg::Num & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = qr_stuff::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const qr_stuff::msg::Num *>(
    untyped_ros_message);
...
{
  return &qr_stuff::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, qr_stuff, msg, Num)() {
  return &qr_stuff::msg::typesupport_fastrtps_cpp::_Num__handle;
}
