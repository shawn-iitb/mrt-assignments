...
#include "qr_stuff/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = qr_stuff::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const qr_stuff::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<qr_stuff::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &qr_stuff::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
